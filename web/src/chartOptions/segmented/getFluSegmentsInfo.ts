...
import {SampleSegmentDepths, SegmentCoords, WgsCovPlotDB} from "../../db";

function getSegmentCoords(selectedSegments: string[], selectedSamples: string[], depths: SampleSegmentDepths): SegmentCoords {
